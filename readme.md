I had started working on this app which was supposed to be a way to automatically transcribe audio from the Lex Fridman podcast, then create embeddings 
